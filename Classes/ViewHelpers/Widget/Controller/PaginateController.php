...
class PaginateController extends \TYPO3\CMS\Fluid\Core\Widget\AbstractWidgetController {
	 ...
	 * @var array
	 */
	protected $configuration = array('itemsPerPage' => 10, 'insertAbove' => FALSE, 'insertBelow' => TRUE, 'maximumNumberOfLinks' => 99, 'displayResultRange' => TRUE, 'addQueryStringMethod' => '');
	...
	public function indexAction($currentPage = 1) {
		...
		if((bool) $this->configuration['displayResultRange']) {
			$displayRangeResults = array(($itemsPerPage * ($this->currentPage - 1)) + 1, $itemsPerPage ? (($itemsPerPage * $this->currentPage) < $this->totalAmountOfObjects ? ($itemsPerPage * $this->currentPage) : $this->totalAmountOfObjects) : $this->totalAmountOfObjects);
		} else {
